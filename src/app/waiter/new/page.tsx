        ...
        <div className="lg:w-1/3 space-y-6">
          ...
          <div className="bg-white p-5 rounded-lg shadow">
            ...
            <div className="space-y-4">
              {/* Order Type */}
              <div>
                <label className="block font-medium text-sm">Order Type</label>
              ...
              {/* Promo Code */}
              <div>
                <label className="block font-medium text-sm">Promo Code</label>
                <input
                  type="text"
              ...
              categories.map((cat) => (
                ...
                >
                  <h3
                    ...
                    onClick={() =>
                      setExpanded({ ...expanded, [cat.id]: !expanded[cat.id] })
                    }
                  >
                    {cat.name}
